      ...
      <Spin spinning={this.store.get('saveLoading')}>
        <div>
          ...
          <div className="container ">
            ...
            {/*页脚*/}
            <Foot goodsFuncName={goodsFuncName} priceFuncName={priceFuncName} isLeave={true} tabType={this.store.get('activeTabKey')} onNext={this.onNext} onPrev={this.onPrev} loading={this.store.get('loading')} />
