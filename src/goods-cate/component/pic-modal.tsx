...
export default class PicModal extends React.Component<any, any> {
  ...
  handleCancel = () => {
    const { modalVisibleFun, imgType } = this.props.relaxProps;
    modalVisibleFun(0, imgType);
    this.setState({
      successCount: 0,
      uploadCount: 0,
      errorCount: 0
        ...
        title={
          <div style={styles.title}>
            ...
            <span style={styles.grey}>
              ...
              <FormattedMessage id="Product.selectedAndUpTo" /> <strong style={styles.dark}>{choosedImgCount}</strong> <FormattedMessage id="Product.canBeSelected" />
            </span>
          </div>
        }
        visible={visible}
   ...
   */
  _handleOk = () => {
    const { beSureImages, modalVisibleFun, imgType } = this.props.relaxProps;
    beSureImages();
    modalVisibleFun(1, imgType);
    this.setState({
      successCount: 0,
      uploadCount: 0,
      errorCount: 0
