...
export default class GoodsActor extends Actor {
  ...
  @Action('goodsActor:addUsedStandard')
  addUsedStandard(state, goodsIds: IList) {
    return state.set('usedStandard', goodsIds);
  }
}
