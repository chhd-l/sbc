...
export default class TodoItems extends React.Component<any, any> {
  ...
  componentWillUnmount() {
    ...
    console.log(tradeCustomerView, 11111111);
  }

  static getDerivedStateFromProps(nextProps, prevState) {
    const { tradeCustomerView } = nextProps.relaxProps;
  ...
  render() {
    const { tradeCustomerView } = this.state;

    setTimeout(() => {
      console.log(tradeCustomerView);
    });
    return (
      <div>
        {tradeCustomerView && (
                  ...
                  <div className="content space-between">
                    <div className="mode">
                      ...
                      <div className="mode-per">
                        {tradeCustomerView.revenueRate ? (
                          <img
                            src={
                              tradeCustomerView.revenueRate > 0 ? icon1 : icon2
                            }
                            width="14"
                            height="14"
                          />
                    ...
                    <div className="mode">
                      ...
                      <div className="mode-num">
                        <span>$</span>
                        <span>
                          {tradeCustomerView.averageBasket ? (
                            <CountUp
                    ...
                    <div className="mode">
                      ...
                      <div className="mode-per">
                        {tradeCustomerView.conversionRate ? (
                          <img
                            src={
