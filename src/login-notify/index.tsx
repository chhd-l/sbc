...
export default withOktaAuth(
  class LoginNotify extends React.Component<any, any> {
    store: AppStore;
          ...
          <Form style={styles.notify}>
            ...
            <FormItem style={{ marginBottom: 30 }}>
              <div style={styles.reviewWord}>
                <FormattedMessage id="Public.UnderReview" />
              </div>
            </FormItem>
            <FormItem style={{ marginBottom: 40 }}>
              <div style={styles.notifyWord}>
                <FormattedMessage id="Public.Yourapplication" />
              </div>
            </FormItem>
            <FormItem style={{ marginBottom: 30 }}>
              <Button type="primary" size="large" style={styles.returnBtn} onClick={(e) => this._handleReturn(e)}>
                <Icon type="arrow-left" /> <FormattedMessage id="Public.Return" />
              </Button>
            </FormItem>
          </Form>
        </div>
