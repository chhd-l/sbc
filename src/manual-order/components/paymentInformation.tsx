...
export default class PaymentInformation extends React.Component<any, any> {
  ...
  componentDidMount() {
    ...
    window.open(`http://shopstg.royalcanin.com/de/cart?token=${token}`, 'newwindow', 'height=500, width=800, top=100, left=100, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="interaction">{/* <iframe src="http://shopstg.royalcanin.com/us/cart" style={{height:450,width:'100%'}} frameBorder="0"></iframe> */}</div>
      </div>
    );
  }
}
