...
export default class ReductionSubscritionLevels extends React.Component<any, any> {
  constructor(props) {
    super(props);
    this.state = {
              ...
              <HasError>
                <FormItem>
                  ...
                  {getFieldDecorator(`level_rule_reduction_${index}`, {
                    ...
                    initialValue: level.firstSubscriptionOrderReduction
                  })(
                    <Input
                      style={{ width: 200 }}
                      placeholder={'0.01-99999999.99'}
                      onChange={(e) => {
                        this.onChange(index, 'firstSubscriptionOrderReduction', e.target.value);
                      }}
                    />
                  )}
                  <span>
