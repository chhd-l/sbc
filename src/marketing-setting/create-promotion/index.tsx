    ...
    if (props.match.params.type == 'promotion') {
      ...
      setFormData({
        ...
        Conditions: {
          ...
          customerLevelIds: detail?.marketingCustomerLevelList?.length > 0 ? detail?.marketingCustomerLevelList?.filter((item) => item.customerLevelId).map((item) => item.customerLevelId) : [],
      ...
      setFormData({
        ...
        Conditions: {
          ...
          customerLevelIds: detail?.couponCustomerLevelList?.length > 0 ? detail?.couponCustomerLevelList?.filter((item) => { return item.customerLevelId }).map((item) => item.customerLevelId) : [],
          customProductsType: detail.customProductsType || 0,
          customProductsIncludeType: detail.customProductsIncludeType || 0,
          storeCateIds: ReStoreCateIds(detail.storeCateIds || []),
          attributeValueIds: ReStoreCateIds(detail.attributeValueIds || []),
