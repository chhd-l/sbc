        ...
        {(this.state.invoiceType == '0' || this.state.invoiceType == '1') && (
          <div>
              ...
              <FormItem {...formItemLayout} label={<span>&nbsp;</span>} colon={false}>
                <Row>
                  <Col span={16}>
                    ...
                    <p>单位纳税人识别号:{invoiceResponse.get('taxpayerNumber')}</p>
            ...
            {customerInvoiceTempAddressVisiable && (
              <Row>
                <Col offset={3}>
                  <FormItem label="所在地区" hasFeedback {...addressformItemLayout}>
                  ...
                  <FormItem label="详细地址" hasFeedback {...addressformItemLayout}>
                  ...
                  <FormItem label=" 收货人" hasFeedback {...addressformItemLayout}>
                  ...
                  <FormItem label="手机号码" hasFeedback {...addressformItemLayout}>
