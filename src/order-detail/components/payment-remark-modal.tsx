      ...
      >
        <Tabs>
          <Tabs.TabPane key="1" tab={<FormattedMessage id="Order.request" />}>
            <ReactJson src={requestJson} enableClipboard={false} displayObjectSize={false} displayDataTypes={false} style={{wordBreak:'break-all'}} />
          </Tabs.TabPane>
          <Tabs.TabPane key="2" tab={<FormattedMessage id="Order.response" />}>
            <ReactJson src={responseJson} enableClipboard={false} displayObjectSize={false} displayDataTypes={false} style={{wordBreak:'break-all'}} />
          </Tabs.TabPane>
        </Tabs>
      </Modal>
    );
