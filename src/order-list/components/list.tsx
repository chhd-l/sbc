                ...
                <tbody>
                  <tr>
                    ...
                    <td style={{ width: '18%' }}>
                      ...
                      {installmentPrice && installmentPrice.totalPrice ? installmentPrice.totalPrice.toFixed(v.get('subscriptionType')==='Individualization'?4:2) : tradePrice.toFixed(v.get('subscriptionType')==='Individualization'?4:2)}
                    </td>
                    {/* Quantity */}
