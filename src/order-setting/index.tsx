...
class OrderSetting extends Component<any, any> {
  ...
  render() {
    const { title, message, paymentOnlineForm, paymentCashForm, unlimitedOnlineForm, unlimitedCashForm, paymentSequence, paymentCategory } = this.state;
        ...
        <div className="container-search">
          ...
          <Form style={{ marginTop: 20 }} layout="horizontal" labelCol={{ span: 6 }} wrapperCol={{ span: 18 }} labelAlign="right">
            <FormItem label="Order payment sequence">
              <div>
                <Radio.Group onChange={this.handleSequenceChange} value={paymentSequence}>
                  <Radio.Button value="Payment before delivery">Payment before delivery</Radio.Button>
                  <Radio.Button value="Unlimited">Unlimited</Radio.Button>
                </Radio.Group>
                <p style={{ fontSize: 12, lineHeight: 1 }}>Select "Payment before delivery", the customer must pay for the order before the merchant can ship, select "Unlimited", regardless of whether the customer pays or not</p>
              </div>
            </FormItem>
            ...
            <FormItem label="Payment category">
              <div>
                <Radio.Group onChange={this.handleCategoryChange} value={paymentCategory}>
                  <Radio.Button value="Online payment">Online payment</Radio.Button>
