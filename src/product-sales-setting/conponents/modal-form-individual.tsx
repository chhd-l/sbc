...
class ModalFormIndividual extends Component<Props, any> {
    ...
    render() {
        ...
        return (
            <Modal
                title='Add new individual frequency'
                visible={visible}
                    ...
                    <Form.Item label="Frequency type">
                        {getFieldDecorator('type', {
                            ...
                            <Select placeholder="Please input  frequency type!">
                                <Select.Option value="Frequency_month_individual">
                                    <FormattedMessage id="Product.FrequencyMonth" />
                                </Select.Option>
                                <Select.Option value="Frequency_week_individual">
                                    <FormattedMessage id="Product.FrequencyWeek" />
                                </Select.Option>
                                <Select.Option value="Frequency_day_individual">
