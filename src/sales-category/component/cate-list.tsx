        ...
        {rowInfo.get('isDefault') == 1
          ...
          ? // 一级分类(非默认分类)可添加子分类
            [
              ...
              //     <a key="item1" style={styles.edit} onClick={this._addChildrenCate.bind(this, rowInfo.get('storeCateId'), rowInfo.get('cateName'), rowInfo.get('goodsCateId'))} className="iconfont iconicon">
