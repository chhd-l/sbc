...
class StepNewConsent extends Component<any, any> {
  constructor(props) {
    super(props);
    this.state = {
      pageType: RCi18n({ id: 'Setting.Detail' }),
      content: [],
      consentTitle: true,
      detailType: false,
      ...
      <div className="consent-detail">
        <div className="detail space-between">
          ...
          <div className="edit">
            ...
            <BraftEditor className="my-editor" controls={controls} placeholder={RCi18n({ id: 'Setting.Pleaseenterthetext' })} />
