  ...
  constructor(props) {
    super(props);
      ...
      this.state = {
          ...
          editRefund: false,
          refund: props.refundAmount && props.refundAmount.toFixed(2)
      };
  }
        ...
        <Form>
          ...
          <FormItem {...formItemLayout} label="退款金额">
            {getFieldDecorator('actualReturnPrice', {
              initialValue: this.props.refundAmount || Number(0).toFixed(2),
              rules: [
                {
                  required: true,
                  message: '请填写退款金额'
              ...
              onClick={() => {
                this.setState({editRefund: !this.state.editRefund}, () => {
                  if (!this.state.editRefund) {
                    this.props.form.setFieldsValue({
                      actualReturnPrice: this.props.refundAmount
                    });
                    this.setState({refund: this.props.refundAmount});
                  }
                });
              }}
            >
