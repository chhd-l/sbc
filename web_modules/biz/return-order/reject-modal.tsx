...
class RejectModal extends React.Component<any, any> {
  ...
  _handleOk(handleOk: Function) {
    ...
    const text = (window as any).RCi18n({id:'Order.reasonIsEmpty'});
...
class RejectForm extends React.Component<any, any> {
  ...
  render() {
    ...
    const alert1 = (window as any).RCi18n({id:'Order.pleaseInputReason'}) + ' ' + this.props.formType;
    const alert2 = (window as any).RCi18n({id:'Order.oneToOneHun'});
