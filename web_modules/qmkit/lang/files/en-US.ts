...
export default {
  ...
  'Analysis:PleaseRemindThatTheReportWillExpireAfter7DaysAutomatically':
    'Please remind that the report will expire after 7 days automatically.',
  ...
  'Content.RecommenedSize':
    'Recommened size：800*800px the size of a single sheet does not exceed 2M，and the maximum sheets is 10',
  ...
  'Dashboard.Technical Error Happened Default Report Time: Latest 1 hour':
    'Technical Error Happened Default Report Time: Latest 1 hour',
  ...
  faqUrl: 'FAQ(URL)',
  'Fetch.500-502-503':
    'System is deploying, if it does not recovery after 10 mins, please contact the administrator.',
  ...
  'Finance.beProcessedTemporarily':
  ...
  'Finance.invoiceStatus': 'Invoice Status',
  'Finance.InvoiceTips':
    'Use the 0000 to indicate the invoice number. You can increase this number step by step as you can see in the example. If there are not enough 0s, they will be added automatically. Use DD-MM-YYYYY (for example 01-01-2021) for the invoice format.',
  ...
  'Login.passwordcomplex':
    'Password should contain upper and lower case letters, at least 8 characters',
  ...
  'Marketing.AllLandingPages': 'All landing pages',
  ...
  'Marketing.AmountTips':
    'The amount/ percentage is not available because you selected uncompatible option: Cart limit: amount.',
  ...
  'Marketing.AutoShipTips':
    'The gift option is not available because you selected uncompatible option: Type of purchase: autoship.',
  'Marketing.back': 'Back',
  ...
  'Marketing.ByEmailTips':
    'The free shipping option is not available because you selected uncompatible option: Group of customer: by email.',
  ...
  'Marketing.ClubTips':
    'The gift option is not available because you selected uncompatible option: Type of purchase: club.',
  ...
  'Marketing.discountTip':
    'The same product can participate in different types of promotional activities at the same time, but can only participate in one full discount activity',
  'Marketing.DiscountType': 'Discount type',
  'Marketing.DistributeCoupon':
    'Distribute coupon under certain conditiion, including valid period',
  'Marketing.DoesItCummulate': 'Does it cummulate?',
  'Marketing.Download': 'Download',
  'Marketing.Edit': 'Edit',
  'Marketing.EditConfirm':
    'You are about to edit a promotion which is currently active. Do you want to add any changes to this active promotion?',
  ...
  'Marketing.ExcludeProductTips':
    'The gift option is not available because you selected uncompatible option: Products in the cart: exclude.',
  ...
  'Marketing.greaterthan0andlessthan999':
    'Value must only be integers greater than 0 and less than 999',
  ...
  'Marketing.IncludeProductTips':
    'The gift option is not available because you selected uncompatible option: Products in the cart: include.',
  ...
  'Marketing.InputValueBetween':
    'Input value between 0.1-9.9 e.g.9.0 means 90% of original price, equals to 10% off',
  ...
  'Marketing.LandingPageContent': 'Landing page content',
  'Marketing.LandingPageDetails': 'Landing page details',
  'Marketing.LandingPageId': 'Landing page ID',
  ...
  'Marketing.ProductsCommonTips':
    'The free shipping option is not available because you selected uncompatible option: Products in the cart: ',
  ...
  'Marketing.public': 'public',
  'Marketing.QuantityTips':
    'The amount/ percentage is not available because you selected uncompatible option: Cart limit: quantity.',
  ...
  'Marketing.Reduction': 'Reduction',
  'Marketing.reductionTip':
    'The same product can participate in different types of promotional activities at the same time, but can only participate in one full reduction activity',
  ...
  'Marketing.SendingEmailPrescriberCreation':
    'Sending Email automatically by the status of Prescriber creation',
  'Marketing.SendingEmailRecommendation':
  ...
  'Marketing.sendsayTip':
    'Please go to Sendsay to activate Email,and set up your AccessKeyId and AccessKeySecret in the Sendsay.',
  ...
  'Marketing.SpTips':
    'The gift option is not available because you selected uncompatible option: Type of purchase: Single purchase.',
  'Marketing.start': 'Start',
  'Marketing.StartAndEndTime': 'Start and end time',
  'Marketing.StartTime': 'Start time',
  'Marketing.starttimecannotbelessthancurrenttime':
    'The start time cannot be less than the current time',
  ...
  'Marketing.TheCouponCould':
    'The coupon could be used by every customer by filling the code in the promo code area.',
  ...
  'Marketing.ValidityDates':
    'Validity dates for coupon codes must fit in activity dates of the promotion',
  ...
  'Menu.Service fee': 'Service fee',
  'Menu.Service fee template': 'Service fee template',
  ...
  'Order.advanceSearch': 'Advance Search',
  'Order.AfterDays':
    'After days, the customer’s overdue and unprocessed pending orders will automatically confirm the receipt.',
  'Order.AfterDaysAutomatically':
    'After days, the pending received return order will be automatically confirmed',
  'Order.AfterDaysCustomer':
    'After days, the customer’s overdue and unprocessed pending orders will automatically confirm the receipt.',
  'Order.AfterDaysFullrefund': 'After days, the full amount refund will be automatically triggered',
  'Order.AfterDaysLogistics':
    'After days, the logistic information collection will be automatically dismissed',
  'Order.AfterDaysMerchant':
    'After days, the pending review return orders will be automatically approved.',
  'Order.AfterDaysTheMerchant':
    'After days, the pending review return orders will be automatically approved.',
  'Order.AfterHours':
    'After hours, if the customer fails to pay overdue, the order will be automatically voided.',
  'Order.AfterHoursCustomer':
    'After hours, if the customer fails to pay overdue, the order will be automatically voided.',
  'Order.AfterOverdueAndPending':
    'After days, the merchant’s overdue and pending refund orders will be automatically approved.',
  'Order.AfterTheMerchant':
    'After days, the pending received return order will be automatically confirmed',
  'Order.all': 'All',
  'Order.All': 'All',
  'Order.AllowedToInitiate':
    'Within days, customers are allowed to initiate a return and refund application, and orders that have not been shipped can be returned at any time.',
  ...
  'Order.applyRefunds':
    'Within days, customers are allowed to initiate a return and refund application.',
  ...
  'order.audit': 'Audit',
  'Order.auditBasis':
    'Audit basis: product type, product amount, product quantity, whether the product is in stock',
  ...
  'Order.autoAuditExceptCondition3':
    'A pet owner placed more than 5 orders on a day (Only applicable to checkout orders)',
  ...
  'Order.cancelOrderContent': 'Are you sure you want to cancel this order?',
  'Order.cancelOrderModalTitle': 'Order cancellation',
  'Order.cancelOrderSuccessfully': 'Your order has been cancelled successfully',
  ...
  'Order.consumptionTax': 'Consumption Tax',
  ...
  'Order.customerCare': 'Customer Care',
  'Order.CustomerOverdue':
    'After days, the customer’s overdue and unprocessed pending orders will automatically confirm the receipt.',
  ...
  'Order.Filesizecannotexceed': 'File size cannot exceed 2M',
  'Order.Filesizecannotexceed (Copy)': 'File size cannot exceed 2M',
  ...
  'Order.goodWillOrder': 'Good will order',
  ...
  'Order.HoursCustomer':
    'After hours, if the customer fails to pay overdue, the order will be automatically voided.',
  'Order.IfTheCmpleted':
    '3. If the completed order exceeds the set time, the customer will not be able to initiate a return or refund application.',
  'Order.IfTheCustomer':
    '2. If the customer has overdue and unprocessed orders to be received, the receipt will be automatically confirmed.',
  ...
  'Order.logisticsSingleNumber': 'Logistics number',
  'Order.loyaltyPoints': 'Loyalty points redeemed',
  ...
  'order.noAddressAvailable': 'No address available, please input temporary address',
  'Order.noCancelOrder': "No,I don't want to cancel",
  ...
  'order.orderStatus': 'Order status',
  'Order.Ordersution':
    '1. Order settings are associated with the key process of order return processing, please operate with caution, all settings will take effect after clicking Save.',
  'Order.orderTag': 'Order Tag',
  'Order.OrderTime': 'Order time',
  'Order.Ordertime': 'Order time',
  'Order.OrderType': 'Order type',
  'Order.orderType': 'Order type',
  'Order.originalAmount\t': 'Original amount\t',
  ...
  'Order.PleaseaddyourreturOrder.savencredentialsTip':
    'Please add your return credentials to the attachment. Supported picture formats: JPG, JPEG, PNG, GIF, file size no more than 5M, and upload a maximum of 10',
  ...
  'Order.refundableAmountTips2':
    'The refund amount should not be greater than the refundable amount. Please modify it.',
  ...
  'Order.refundAlert3':
    'The default is the amount that the actual amount for the product does not include servife fee and shipping fee.',
  ...
  'order.regularOrder': 'Regular order',
  ...
  'Order.returnOrder.errMsg1':
    'The order is associated with the refund order being processed and cannot be re-applied',
  ...
  'order.seeDetails': 'See details',
  'Order.Select':
    'Select "Payment before delivery", the customer must pay for the order before the merchant can ship, select "Unlimited", regardless of whether the customer pays or not',
  ...
  'Order.SelectRequiresPrescriber':
    'Please select whether the product category requires prescriber',
  ...
  'Order.serviceFeePrice': 'Service fee (including tax)',
  'Order.ServiceOrderlist': 'Order list (Service)',
  'Order.settingTips':
    'The configuration item does not meet the specification, please check and try again!',
  ...
  'Order.Sunday': 'Sunday',
  'Order.sureCancelOrder': 'Yes,I want to cancel this order',
  ...
  'Order.Theamountreturnedmustnotexceed':
    'The amount returned must not exceed the amount refundable',
  'Order.TheMerchant':
    '5. The merchant will automatically confirm the receipt of the pending return orders that have not been processed by the merchant.',
  ...
  'Order.ThePending':
    '4. The pending refund orders that have not been processed by the merchant will be automatically approved.',
  'Order.Thepurchasevolume': 'The purchase volume cannot be greater than the remaining inventory',
  'Order.Thepurchasevolumecannot':
    'The purchase volume cannot be greater than the limit order quantity',
  'Order.Thepurchasevolumecannotbeless ':
  ...
  'PetOwner.addressWithinAlert':
    'Please enter an address that is within the delivery areas of the online store!',
  ...
  'PetOwner.cannotDeletePaymentCard':
    'The card cannot be deleted. A subscription is bound to this card!',
  ...
  'PetOwner.creditCards': 'CREDIT CARDS',
  ...
  'PetOwner.EmailExist': 'The email is already on the blocklist',
  ...
  'PetOwner.TaggingInstruction':
    'Taggings whose descriptions marked set by default can not be deleted and edited.',
  ...
  'PetOwner.verifyAddressAlert':
    'We could not verify the address you provided, please confirm or edit your address to ensure prompt delivery.',
  ...
  'Prescriber.Recommendation.optimal':
    "Associer des aliments humides avec les croquettes permet à votre chat de profiter des bienfaits des deux types d’aliments,  respecte le comportement alimentaire naturel du chat et l'aide par ailleurs à maintenir le poids idéal à condition de respecter la quantité d'aliment recommandée.",
  ...
  'Product.Addproducttip1':
    '1. Regular product is individual good like French Bulldog Puppy Dry Dog Food.',
  'Product.Addproducttip2':
    '2. Bundle product is several individual goods that are sold to consumers as one combined package.',
  'Product.Addproducttip3':
    '3. Service is consisted of activities, benefits or satisfactions offered for sale that are intangible like vet clinics.',
  ...
  'Product.approvalStatus': 'Approval status',
  'Product.Are you sure you want to delete these products?':
  ...
  'Product.associateAttribute':
    'Product category is set by RC staff, you can associate attribute to product category.',
  ...
  'Product.attributeInformation': 'Attribute information',
  'product.attributeInformation': 'Attribute information',
  'Product.Attributeinformationdesc':
  ...
  'Product.AttributeValue': 'Attribute value',
  'Product.Attributevalueisinput':
    "Attribute value' is input from other system, which can not be modified, but you can modify 'display name'. If you want to modify 'attribute value', you could contact us.",
  ...
  'Product.Categorytypedesc':
    'English name of sales category for searching specific type producy, you need to create Alias name in dictionary first, and then choose from.',
  ...
  'Product.CommodityLibraryImport': 'Commodity library import',
  'Product.commodityLibraryImportInfo':
    'The products imported from the commodity library are initially reviewed / off the shelf. Please add the information before selling them;',
  ...
  'Product.corporatepurchaseactivity':
  ...
  'Product.DeleteTheCurrentCategory':
  ...
  'Product.FilterAttributes':
    'Filter attributes can be chosen from attributes, which are associated with product category',
  ...
  'Product.Inventorywarningdesc':
    'Set a quantity that when products are below this certain quantity, they are considered as ‘Low inventory’ and will be shown in the list below.',
  ...
  'Product.marketpriceexcl': 'Market price(excl.VAT)',
  'Product.marketpriceincl': 'Market price(incl.VAT)',
  'Product.Marketpricepercentage': 'Market price percentage',
  'Product.MarketpricepercentageIncl': 'Market price percentage (Incl. VAT)',
  ...
  'Product.notethatpleaseCarryoutbatch':
  ...
  'Product.One-clickimportofplatformcommoditylibrary':
    'One-click import of platform commodity library',
  ...
  'Product.OperationDescription-1':
    '1、Please download the product import template first, and input the product data according to the requirements in the annotation. Failure to input the requirements will cause the product import to fail.',
  'Product.OperationDescription-2':
  ...
  'product.operationInstruction': 'Operation instruction',
  'Product.operationInstructionFirst':
    'Until filled all required fields, the product could be published. ',
  'Product.operationInstructionSecond':
    'The product information tab, product price tab, product inventory tab must be filled before published.',
  'Product.operationInstructionThird':
    "If you do not need to set the related product or SEO, you can click 'Next' directly after editing the inventory information.",
  ...
  'Product.PriceTableColumnMarketPriceExcl': 'Market price (Excl. VAT)',
  'Product.PriceTableColumnMarketPriceIncl': 'Market Price (Incl. VAT)',
  'Product.PriceTableColumnName': 'Product name',
  'Product.PriceTableColumnPurchasePrice': 'Purchase price(Incl. VAT)',
  'Product.PriceTableColumnPurchasePriceExcl': 'Purchase price (Excl. VAT)',
  ...
  'Product.Productprice': 'Product price',
  'Product.ProductPrice.priceprompt':
    'Market price percentage should larger than subscription price percentage!',
  ...
  'Product.returnToTheListPage':
    'Do you want to return to the list page? The information currently filled in will be lost.',
  ...
  'Product.reviewManagement': 'Review management',
  'Product.ReviewOverallrating':
    'Overview：Overall rating   -    Shopping rating   -    Purchase experience rating   -    Logistic rating   -',
  ...
  'Product.SetQuantity':
    'Set a quantity that when products are below this certain quantity, they are considered as ‘Low inventory’ and will be shown in the list below.',
  'Product.settheSalescategory':
    'Set the Sales category field to show product in the respective PLP.',
  'Product.shelve': 'On/Off shelve',
  'Product.shelvesstatusinSPUisY':
    'If the shelves status in SPU is on shelves, at lease one shelves status of Sku is on shelves.',
  ...
  'Product.subscriptionStatus': 'Subscription status',
  'product.subscriptionStatus': 'Subscription status',
  'Product.subscriptionstatusinSPUisY':
    'If the subscription status in SPU is Y, at lease one subscription status of Sku is Y and the shelves status is on shelves.',
  'Product.subscriptionType': 'Subscription type',
  'Product.subscriptiontypeinSPUisclub':
    'If the subscription type in SPU is club, at lease one subscription type of Sku is club',
  ...
  'Product.TheCurrentCategory':
    'The current category is associated with the product, please modify and then delete.',
  'Product.thedistributionactivity':
  ...
  'Product.TheEnabledFilters':
    'The enabled filters will show in the ‘Filter’ section for customer to choose and filter out desired products.',
  'Product.TheEnabledSort':
    'The enabled sort conditions will show in the ‘Sort by’ section for customer to sort products in desired orders.',
  ...
  'Product.ThisProductIsParticipating':
  ...
  'Product.usingTheKeyboardEnterKey':
    'You can quickly add multiple specifications using the keyboard enter key',
  ...
  'Public.editor.editorVerification':
  ...
  'Public.exportConfirmTip':
    'The export report task is operating, and it will show in the analyze module/ Export report. You can download it once you receive the result email.',
  ...
  'Public.ordelineTip':
    'If nothing is selected below, then by default only ordeline fields are exported',
  ...
  'Public.YourclientID':
    'Your client ID is specified on your Royal Canin invoice. It can be an e-mail address or a client number',
  ...
  'Resources.bulk_planning_btn_warning':
    'Please select one or more items in the resources list below before clicking.',
  ...
  'ServiceFee.addServiceFeeTemplate': 'Add Service Fee Template',
  'ServiceFee.AddSetting': 'Add setting',
  'ServiceFee.Amount': 'Amount',
  'ServiceFee.AreYouSureDisable': 'Are you sure to disable this?',
  'ServiceFee.AreYouSureEnable': 'Are you sure to enable this?',
  'ServiceFee.Calculation': 'Service Fee Calculation',
  'ServiceFee.editServiceFeeTemplate': 'Edit Service Fee Template',
  'ServiceFee.operation': 'operation',
  'ServiceFee.PaymentMethod': 'Payment method',
  'ServiceFee.Percent': 'Percent',
  'ServiceFee.RuleName': 'Rule name',
  'ServiceFee.SetUpYourOwnRule': 'Set up your own rule',
  ...
  'Setting.AddressManagementisusedfor':
    'Address Management is used for shipping and tax setting in store portal or shop.',
  ...
  'Setting.BillingRules': 'Delivery rules',
  ...
  'Setting.BrandUpto50brands':
    'Brand，Up to 50 brands can be signed, and the approval rate for uploading authorization documents is higher.',
  ...
  'Setting.DeleteTheCurrentCategory':
    'Delete the current category, and all categories under the category will also be deleted. Are you sure to delete this category?',
  ...
  'Setting.departmentManagementInfo1':
    'During initialization, it can be imported by using the "Detach creation" department;',
  'Setting.departmentManagementInfo2':
    'Support drag and drop between departments at the same level;',
  'Setting.departmentManagementInfo3':
    'Each department can set up a supervisor, the supervisor can see and manage the employees of his department and sub-departments, and the supervisor has all the data permissions of the salesmen of his department and his sub-departments;',
  ...
  'Setting.leaseselect':
    'lease select the last level category to sign the contract, already signed',
  ...
  'Setting.Manage':
    'Manage your commonly used carriers companies, easy to choose when ordering and shipping, up to 20 carriers companies can be set up.',
  ...
  'Setting.OXXO': 'OXXO',
  'Setting.p':
    'Commodity video size recommended 30M, maximum limit 50M, support file type: mp4, recommended duration is less than or equal to 90s, greater than or equal to 6s, recommended video ratio of 7:9',
  'Setting.Page': 'Page',
  ...
  'Setting.Please':
    'Please set the shipping calculation mode first. When selecting asingle product, the order shipping uses the shipping charge of  each product; if the store shipping is selected, the single product shipping template selected by the product will not be effective, and the unified shipping will be charged according to  the order amount;',
  ...
  'Setting.productsWithoutFreightTemplate':
  ...
  'Setting.selectTheParentCategoryFirst':
    'To add a new category, please select the parent category first',
  ...
  'Setting.storeFaviconTip':
    'PC mall favicon, you can add up to one, the picture format is limited to ico, the recommended size is 36*36, and the size does not exceed 2M',
  ...
  'Setting.Supportjpg':
    'Support jpg, jpeg, png, gif, single sheet no more than 2M, maximum upload 10 sheets',
  'Setting.Supportjpgjpegpng':
    'Support jpg, jpeg, png, gif, single sheet no more than 2M, maximum upload 2 sheets',
  ...
  'Setting.TheCurrentClassification':
  ...
  'Setting.Trademarkregistration':
    'Trademark registration certificate / acceptance letter / brand authorization letter',
  'Setting.Tuesday': 'Tuesday',
  'Setting.turnText1': 'Turn on and off to set time frame',
  'Setting.turnText2':
    'Turn on and off to set time frame;Return to your previous setting when the time frame has passed',
  'Setting.Type': 'Type',
  ...
  'Setting.Youdonthave':
    'You don`t have a store. Please submit your application for opening a store',
  ...
  stock: 'Stock',
  'Store.addpayment': 'Add a bank account so you can get paid',
  'Store.address1': 'Store address 1',
  'Store.addressexample':
    'The Store address should include both Street name and house number. E.g. City 35',
  'Store.agreewith': 'I agree with the legal contract',
  'Store.bankInfo': 'Bank information',
  'Store.basicInfo': 'Basic information',
  'Store.CardBack': 'Back',
  'Store.CardFront': 'Front',
  'Store.CardType.drivelic': 'Driving License',
  'Store.CardType.id': 'ID',
  'Store.CardType.passport': 'Passport',
  'Store.companyname': 'Legal company name',
  'Store.companyname.Tooltip':
    'This is the company registration number (KVK number). 8-digits normally in Netherland',
  'Store.companynamerepeated': 'Legal company name is repeated',
  'Store.companynumber': 'Chamber of Commerce number',
  'Store.companynumberrepeated': 'Chamber of Commerce number is repeated',
  'Store.companynumbertip': 'This is the registration number (KVK number).',
  'Store.First name of Clinic Manager': 'First name of Clinic Manager',
  'Store.Last name of Clinic Manager': 'Last name of Clinic Manager',
  'Store.countryrepeated': 'Country is repeated',
  'Store.dateofbirth': 'Date of birth',
  'Store.fail': 'Fail?',
  'Store.fillincontactinfo': 'Fill in legal information and contact person',
  'Store.housenumber': 'House number',
  'Store.iban': 'IBAN',
  'Store.intro': 'Introduction',
  'Store.intro.Tip': 'This will be displayed in the store finder & shop introduction page',
  'Store.jobTitle': 'Job title',
  'Store.marketpriceper': 'Market price percentage',
  'Store.namenono': 'Name should not contain numbers',
  'Store.orderauditsetting': 'Order audit setting',
  'Store.ownercity': 'Owner city',
  'Store.ownername': 'Owner name',
  'Store.plscheckfields': 'Please check these fields',
  'Store.postcode': 'Postcode',
  'Store.province': 'Province',
  'Store.province.Tip': 'Province abbreviation. E.g. GLD',
  'Store.recomsize': 'recommended size',
  'Store.recomsize.Tip': 'Logo would be displayed in store homepage',
  'Store.savetonext': 'Save and next',
  'Store.selltoclinic': 'Sell to clinic',
  'Store.Sell to clinic number': 'Sell to clinic number',
  'Store.selltoclinic.Tip': 'Please contact your sales rep. if necessary',
  'Store.setprice': 'Set a price for your product',
  'Store.shareHolder': 'Shareholder',
  'Store.shareHolderType': 'Shareholder type',
  'Store.signatories': 'Signatories',
  'Store.storeDomain': 'Store domain',
  'Store.storeInfo': 'Store information',
  'Store.storenamerepeated': 'Store name is repeated',
  'Store.street': 'Street name',
  'Store.submitForAudit': 'Submit for auditing',
  'Store.submittip': 'You can submit Ayden account once fill all required fields',
  'Store.subscriptionper': 'Subscription price percentage',
  'Store.supportdoc': 'Supported document',
  'Store.supportdoctip': 'Please upload all the supported documents completely',
  'Store.taxid': 'Tax ID',
  'Store.tellusmore': 'Tell us more about your store',
  'Store.typeofbusi': 'Type of business',
  'Store.upshopfav': 'Upload the Shop favicon',
  'Store.upshopfav.Tip': 'Favicon would',
  'Store.upshoplogo': 'Upload the Shop logo',
  'Store.waitForAudit': 'Wait for auditing',
  ...
  'storeName.Tip': 'The Store name would be displayed in the webshop URL',
  ...
  'Subscription.brand': 'Brand',
  'Subscription.Buy the products regulary to enjoy the membership gift':
    'Buy the products regulary to enjoy the membership gift',
  ...
  'Subscription.Consumption gift is set for order type is club, and subscription order is the recurrent by default':
    'Consumption gift is set for order type is club, and subscription order is the recurrent by default;',
  'Subscription.Consumption gift only delivered one time for the same conditions club':
    'Consumption gift only delivered one time for the same conditions club.',
  ...
  'Subscription.Days1':
    'Days ahead new orders being created, an email will be sent to pet owners to remind them of new orders.',
  'Subscription.Days2':
    'Days ahead pet owners’ card expired, an email will be sent to pet owners to remind them of card expiration.',
  ...
  'Subscription.DeleteTip': 'Are you sure you want to remove this product from your subscription?',
  ...
  'Subscription.EmailPaymentIntervalsDesc':
    'Attempts between first and last emails due to payment issues',
  'Subscription.EmailReminderIntervals': 'Email reminder intervals',
  'Subscription.EmailReminderIntervalsDesc':
    'Attempts between first and last emails due to inventory issues',
  ...
  'Subscription.Higher retention rare and more repurchases':
    'Higher retention rare and more repurchases',
  ...
  'Subscription.ReminderSwitchProductDesc':
    'Days before the next lifestage, an email will be sent to pet owners to recommend a new product',
  'Subscription.RemindOfCardExpiration': 'Remind of card expiration',
  'Subscription.RemindOfNewOrders': 'Remind of new orders',
  'Subscription.RemoveAssociationFirst':
    'This card cannot be removed due to the subscription association, please remove the association first.',
  ...
  'Subscription.SubscriptionOtherPromotions':
    'Subscription plan can be applied with other promotions',
  ...
  'Subscription.WelcomeboxHint2':
    'Welcome box only delivered one time for the same product category',
  ...
  'Verify.required': 'This is required field',
  video: 'Video',
  ...
  'Clinic.OpenTip':
    'Please use ‘/’ to wrap the line. E.g., Mon - Sat: 08:00 - 12:30, 13:30-15:30 /Sat: 09:00 - 12:00 /Sun: Closed',
