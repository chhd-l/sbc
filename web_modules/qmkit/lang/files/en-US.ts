...
export default {
  ...
  "Login.passwordcomplex": "Password should contain upper and lower case letters, at least 8 characters",
  ...
  "Order.refundAlert3": "The default is the amount that the actual amount for the product does not include servife fee and shipping fee.",
  ...
  "Store.addressexample": "The Store address should include both street name and house number. E.g. City 35",
