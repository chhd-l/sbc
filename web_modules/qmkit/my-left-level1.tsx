...
export default class MyLeftLevel1 extends React.PureComponent<any, any> {
  ...
  render() {
    ...
    // 一级菜单选中索引
    let firstActive = sessionStorage.getItem(cache.FIRST_ACTIVE) || this.state.firstActive;
    ...
    return (
      ...
      >
        <Menu inlineIndent={16} theme="light" mode="inline" selectedKeys={level1SelectKeys}>
          {/*头部一级菜单*/}
          {auditState == 1 &&
          ...
          {Const.SITE_NAME === 'MYVETRECO' && shopDomain ? (
            <Menu.Item key="myvetreco-shop-editor" style={styles.navItem}>
              <a href={myvetreco_shop_domain_url} target="_blank">
                ...
                <span
                  ...
                  title={RCi18n({ id: `Menu.Shop editor` })}
                >
                  <FormattedMessage id="Menu.Shop editor" />
                </span>
              </a>
            </Menu.Item>
          ) : null}
