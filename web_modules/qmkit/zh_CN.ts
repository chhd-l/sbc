...
'confirmPassword':'确认密码',
  ...
  'Editor.indent':'缩进',
  'Editor.lineHeihgt':'行高',
  'Editor.fontColor':'文字颜色',
  'Editor.background':'背景颜色',
  'Editor.':'链接',
  'Editor.numberedList':'序列',
  'Editor.align':'对齐',
  'Editor.source':'源码',
  'Editor.quote':'引用',
  'Editor.emoticons':'表情',
  ...
  'Editor.right':'靠右',
  'Editor.justify':'两端',
  'Editor.unordered':'无序列表',
  'Editor.ordered':'有序列表',
  'Editor.sina':'新浪',
  'Editor.emoji':'emoji',
  'Editor.gesture':'手势',
  'Editor.imageLink':'图片链接',
  'Editor.uploadImage':'上传图片',
  'Editor.networkImage':'网络图片',
  'Editor.linkText':'链接文字',
  'Editor.unlink':'取消链接',
  'Editor.viewLinks':'查看链接',
  'Editor.insertVideo':'插入视频',
  'Editor.uploadLocalvideo':'上传视频',
  'Editor.rows':'行',
  'Editor.columns':'列',
  'Editor.deleteRow':'添加行',
  'Editor.insertRow':'删除行',
  'Editor.insertColumn':'添加列',
  'Editor.deleteColumn':'删除列',
  'Editor.setHeader':'设置表头',
  'Editor.cancelHeader':'取消表头',
  'Editor.insertTable':'插入表格',
  'Editor.deleteTable':'删除表格',
  'Editor.deleteCode':'删除代码',
  'Editor.editCode':'修改代码',
  'Editor.insertCode':'插入代码',
  'Editor.images':'图片',
  'Editor.greaterThan':'大于',
  'Editor.isNotImage':'不是图片',
  'Editor.returnResults':'返回结果',
  'Editor.imageTimeout':'上传图片超时',
  'Editor.imageError':'上传图片错误',
  'Editor.imageFailed':'上传图片失败',
  'Editor.insertImageError':'插入图片错误',
  'Editor.onceMostAtUpload':'一次最多上传',
  'Editor.downloadLinkFailed':'下载链接失败',
  'Editor.imageValidateFailed':'图片验证未通过',
  'Editor.serverReturnStatus':'服务器返回状态',
  'Editor.imageReturnResultsError':'上传图片返回结果错误',
  'Editor.replaceImageType':'请替换为支持的图片类型',
  'Editor.insertedIsNotRecognized':'您插入的网络图片无法识别',
  'Editor.editorVerification':'您刚才插入的图片链接未通过编辑器校验',
  'Editor.insertVideoError':'插入视频错误',
  'Editor.videoLink':'视频链接',
  'Editor.isNotVideo':'不是视频',
  'Editor.videoValidateFailed':'视频验证未通过',
  'Editor.videos':'个视频',
  'Editor.uploadVideoTimeout':'上传视频超时',
  'Editor.uploadVideoError':'上传视频错误',
  'Editor.uploadVideoFailed':'上传视频失败',
  'Editor.videoReturnResultsRrror':'上传视频返回结果错误',
